...
namespace PhotoSprite
{
    public partial class WinMain : Form
    {
        ...
        public WinMain(string fileName)
        {
            ...
            Logger.Instance().Log("WinMain fileName = " + fileName);
        ...
        private void Initialize()
        {
            ...
            this.ClientSize = new System.Drawing.Size(Screen.GetWorkingArea(this).Width / 2, Screen.GetWorkingArea(this).Height / 2);
            this.Name = "WinMain";
